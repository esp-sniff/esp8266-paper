...
potrebbe essere utile collegare una scheda di rete LTE/4G/3G\improvement{Inserisci link al sito del produttore di un esempio di scheda di questo tipo, anche una chiavetta USB-3G ad esempio}
