...
che nel periodo delle Olimpiadi del 2012 aveva posizionato nella capitale britannica 100 bidoni dell'immondizia dotati di schermo, impiegato per visualizzare pubblicità come dei normali \textit{advertisement kiosk}.
...
L'utilizzo di dispositivi per il monitoraggio della folla tramite WiFi è divenuto abbastanza popolare in ambienti con un grande passaggio di gente come grandi negozi, centri commerciali e campus universitari, dunque gli esempi sarebbero innumerevoli.
In bibliografia sono riportati ulteriori articoli e ricerche in merito.
